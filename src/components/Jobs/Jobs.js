        ...
        return (
          <JobCard key={job._id} job={job} plusMinus={plusMinus}>
            {job.displayJobDescription ? (
              <div>
                <p className="jobDescription" id={index}>
                  {job.jobDescription}
                </p>
              </div>
            ) : (
            ...
            <button
              ...
              title="Display Job Description"
              onClick={(e) => {
                plusMinus(e);
                dispatch(displayJobDescription(job));
              }}
            ></button>
            <button className="apply-button" onClick={() => applyWindow(job)}>
              APPLY
            </button>
          </JobCard>
        );
